...
Every file contains an `id`, a publication `status`, a question, consecutively lettered answers, one hidden correct-answer comment, and an explanation inside a collapsed `<details>` block.
